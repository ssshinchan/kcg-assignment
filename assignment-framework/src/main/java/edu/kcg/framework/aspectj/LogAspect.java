...
import edu.kcg.common.enums.BusinessStatus;
import edu.kcg.common.enums.HttpMethod;
import edu.kcg.common.filter.PropertyPreExcludeFilter;
import edu.kcg.common.utils.ExceptionUtil;
        ...
        if (paramsArray != null && paramsArray.length > 0)
        {
            for (Object o : paramsArray)
            {
                if (StringUtils.isNotNull(o) && !isFilterObject(o))
                {
                    ...
                    {
                        log.error("リクエストパラメータ組み立て例外 msg:{}, パラメータ:{}", e.getMessage(), paramsArray, e);
                    }
                }
            }
        }
