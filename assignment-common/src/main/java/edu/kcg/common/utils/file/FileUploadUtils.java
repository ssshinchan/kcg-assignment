package edu.kcg.common.utils.file;
...
import edu.kcg.common.exception.file.FileNameLengthLimitExceededException;
import edu.kcg.common.exception.file.FileSizeLimitExceededException;
import edu.kcg.common.exception.file.InvalidExtensionException;
import edu.kcg.common.utils.DateUtils;
import edu.kcg.common.utils.StringUtils;
import edu.kcg.common.utils.uuid.IdUtils;
import edu.kcg.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = AssignmentConfig.getProfile();
    ...
    {
        int dirLastIndex = AssignmentConfig.getProfile().length() + 1;
