    ...
    <el-form>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="4">
                いいえ。
                <el-input-number v-model='average01' :min="1" :max="4" /> 毎週
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="6">
                指定する
                <el-select class="multiselect" clearable v-model="checkboxList" placeholder="複数選択可能" multiple :multiple-limit="6">
                    <el-option v-for="item in weekList" :key="item.key" :label="item.value" :value="item.key" />
                </el-select>
            </el-radio>
        </el-form-item>
