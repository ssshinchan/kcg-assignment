    ...
    <el-form>
        ...
        <el-form-item>
            <el-radio :value="4" v-model='radioValue'>
                から
                <el-input-number v-model='average01' :min='fullYear' :max="2098"/> 年から始まり、毎年
                <el-input-number v-model='average02' :min="1" :max="2099 - average01 || fullYear"/> 年に1回実施
            </el-radio>
        ...
        <el-form-item>
            <el-radio :value="5" v-model='radioValue'>
                指定する
                <el-select clearable v-model="checkboxList" placeholder="複数選択可能" multiple :multiple-limit="8">
