...
<!--
        ...
        <el-tooltip content="書類 のアドレス" effect="dark" placement="bottom">
...
-->
        ...
        <el-tooltip content="テーマモード" effect="dark" placement="bottom">
        ...
        <el-tooltip content="メッセージ通知" effect="dark" placement="bottom">
...
function logout() {
  ElMessageBox.confirm('ログアウトしてシステムを終了してもよろしいですか?', 'ヒント', {
