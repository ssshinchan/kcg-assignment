<template>
  <el-drawer v-model="showSettings" :withHeader="false" :lock-scroll="false" direction="rtl" size="300px">
    <div class="setting-drawer-title">
      <h3 class="drawer-title">メニューナビゲーション設定</h3>
    </div>
    <div class="nav-wrap">
      <el-tooltip content="左側のメニュー" placement="bottom">
        <div class="item left" @click="handleNavType(1)" :class="{ activeItem: navType == 1 }">
          <b></b><b></b>
        </div>
      </el-tooltip>

      <el-tooltip content="ミックスメニュー" placement="bottom">
        <div class="item mix" @click="handleNavType(2)" :class="{ activeItem: navType == 2 }">
          <b></b><b></b>
        </div>
      </el-tooltip>
      <el-tooltip content="トップメニュー" placement="bottom">
    ...
    <div class="setting-drawer-title">
      <h3 class="drawer-title">テーマのスタイル設定</h3>
    </div>
    <div class="setting-drawer-block-checbox">
      <div class="setting-drawer-block-checbox-item" @click="handleTheme('theme-dark')">
        <img src="@/assets/images/dark.svg" alt="dark" />
        <div v-if="sideTheme === 'theme-dark'" class="setting-drawer-block-checbox-selectIcon" style="display: block;">
          <i aria-label="アイコン: check" class="anticon anticon-check">
    ...
    <h3 class="drawer-title">システムレイアウト構成</h3>

    <div class="drawer-item">
      <span>オンにする Tags-Views</span>
      <span class="comp-style">
    ...
    <el-button type="primary" plain icon="DocumentAdd" @click="saveSetting">設定の保存</el-button>
    <el-button plain icon="Refresh" @click="resetSetting">設定をリセットする</el-button>
  </el-drawer>
...
function saveSetting() {
  proxy.$modal.loading("ローカルに保存しています。お待ちください。...")
...
function resetSetting() {
  proxy.$cache.local.remove('tags-view-visited')
  proxy.$modal.loading("設定キャッシュをクリアして更新しています。お待ちください。...")
