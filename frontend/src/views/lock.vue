<template>
  <div class="lock-container">
    ...
    <div class="lock-card">
      ...
      <div class="lock-hint">システムがロックされています。ロックを解除するにはパスワードを入力してください</div>

      <div class="input-wrap" :class="{ shake: isShaking }">
        <input ref="passwordInput" v-model="password" type="password" placeholder="ログインパスワードを入力してください" class="lock-input" @keydown.enter="handleUnlock" autocomplete="off" />
      ...
      <div class="lock-footer">
        <a href="javascript:;" @click="goLogin">ログアウトして再度ログインする</a>
      </div>
    </div>
  </div>
</template>
