<template>
  <div>
    <el-dialog title="オプションの追加" v-model="open" width="800px" :close-on-click-modal="false" :modal-append-to-body="false"
      @open="onOpen" @close="onClose">
      <el-form ref="treeNodeForm" :model="formData" :rules="rules" label-width="100px">
        <el-col :span="24">
          <el-form-item label="オプション名" prop="label">
            <el-input v-model="formData.label" placeholder="オプション名を入力してください" clearable />
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="オプションの値" prop="value">
            <el-input v-model="formData.value" placeholder="オプションの値を入力してください" clearable>
              <template #append>
