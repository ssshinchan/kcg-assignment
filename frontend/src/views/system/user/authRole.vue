<template>
   <div class="app-container">
      ...
      <h4 class="form-header h4">役割情報</h4>
      <el-table v-loading="loading" :row-key="getRowKey" @row-click="clickRow" ref="roleRef" @selection-change="handleSelectionChange" :data="roles.slice((pageNum - 1) * pageSize, pageNum * pageSize)">
         <el-table-column label="シリアル番号" width="55" type="index" align="center">
         ...
         <el-table-column label="キャラクター名" align="center" prop="roleName" />
         <el-table-column label="許可文字" align="center" prop="roleKey" />
